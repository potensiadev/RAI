  ...
  return (
    ...
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: -10 }}
        className="absolute top-full left-0 right-0 mt-2 rounded-xl bg-slate-800/95 backdrop-blur-sm border border-slate-700 shadow-xl z-50 overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="max-h-80 overflow-y-auto">
          {history.map((item) => (
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 hover:bg-slate-700/50 transition-colors group"
            >
