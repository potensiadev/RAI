...
export function RefundRequestModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-lg mx-4 bg-slate-900 border border-white/10 rounded-2xl shadow-xl">
        {/* Header */}
        ...
        <div className="p-6">
          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="mt-4 text-slate-400">환불 정보를 불러오는 중...</p>
            </div>
          )}
                ...
                {preview.eligible ? (
                  <>
                    ...
                    {preview.usedCreditsCost > 0 && (
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400">사용 크레딧 비용</span>
          ...
          {step === "processing" && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="mt-2 text-slate-400">잠시만 기다려주세요.</p>
            </div>
          )}
